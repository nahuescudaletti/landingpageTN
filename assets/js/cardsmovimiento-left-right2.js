    ...
    timeline.fromTo('#animation-container-3', { x: '-50%' }, { x: '0%', ease: 'linear' });
    timeline.fromTo('#animation-container-4', { x: '50%' }, { x: '0%', ease: 'linear' }, 0); // Inicia al mismo tiempo que la anterior
