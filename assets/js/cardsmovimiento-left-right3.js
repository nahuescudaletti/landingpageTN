    ...
    timeline.fromTo('#animation-container-5', { x: '-50%' }, { x: '0%', ease: 'linear' });
    timeline.fromTo('#animation-container-6', { x: '50%' }, { x: '0%', ease: 'linear' }, 0); // Inicia al mismo tiempo que la anterior
